...
#define SOCK_TCPS_SERVER_PORT 8283 
...
gWIZNETINFO.mac[0] = 0x40;gWIZNETINFO.mac[1] = 0x08;gWIZNETINFO.mac[2] = 0xdc;gWIZNETINFO.mac[3] = 0x00;gWIZNETINFO.mac[4] = 0xab;gWIZNETINFO.mac[5] = 0xcd;	
...
debag = socket(SOCK_TCPS, Sn_MR_TCP, MyPort_N, 0);	//создаем сокет
printf("%d:socet\r\n",debag);	
if (debag == SOCK_TCPS){
